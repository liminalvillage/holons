 ...
 */
export function mergeSelfIntoUsers<T extends UserStore>(store: T): T | UserStore {
 ...
 */
export function buildUserStoreWithSelf(items: UserLike[] | null | undefined): UserStore {
 ...
 */
export function subscribeHolonUsers(opts: SubscribeHolonUsersOptions): () => void {
