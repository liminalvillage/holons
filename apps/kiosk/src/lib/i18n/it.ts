...
export const it: Record<MessageKey, Msg> = {
  ...
  "tasks.graphEmpty":
    "Ancora nessuna dipendenza — i task che si aspettano a vicenda appariranno qui. ✶",
  ...
  "detail.ends": "Fine",
  "detail.endTime": "Ora di fine",
  "detail.pickStartFirst": "Prima scegli l'ora di inizio",
