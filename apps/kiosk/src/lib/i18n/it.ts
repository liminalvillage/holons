...
export const it: Record<MessageKey, Msg> = {
  ...
  "cal.zoomIn": "Ingrandisci",
  "cal.zoomOut": "Riduci",
  "cal.zoomReset": "Tutto l'anno",
  "cal.zoomHint": "Pizzica o Ctrl + rotella per ingrandire",
  ...
  "cal.set.colorFeed": "Colore di {name}",
  "cal.set.colorAria": "Colore {color}",
  "cal.set.colorCustom": "Colore personalizzato",
  "cal.set.colorAuto": "Automatico",
  "cal.set.saveFailed":
  ...
  "detail.copyLink": "Copia il link a questa scheda",
  "detail.linkCopied": "Link copiato",
  ...
  // ── Aggiungi un hub — la scheda dietro il "+" del dock ─────────────────
  "hub.addTitle": "Aggiungi un hub",
  "hub.addHereTitle": "Aggiungi un hub qui",
  "hub.haveTitle": "Ho già un hub",
  "hub.haveBody": "Incolla il suo link o il suo id.",
  "hub.newTitle": "Avvia un nuovo hub",
  "hub.newBody": "Per te, o per un gruppo — tramite Telegram.",
  "hub.newLead":
    "Un hub è una chat Telegram. Scegli quale: si apre Telegram, il bot risponde lì e l'hub compare qui da solo.",
  "hub.personal": "Un hub per me",
  "hub.personalHint": "Una chat privata con il bot",
  "hub.group": "Un hub per un gruppo",
  "hub.groupHint": "Aggiungi il bot a un gruppo, o creane uno",
  "hub.waiting": "In attesa del bot…",
  "hub.waitingBody":
    "Quando il bot ha risposto su Telegram, torna in questa scheda: l'hub si apre da solo.",
  "hub.orPaste": "Oppure incolla quello che ha risposto il bot",
  "hub.pasteHint": "Scrivi /id nella chat dell'hub se ti serve di nuovo.",
  "hub.open": "Aggiungilo",
  "hub.back": "Indietro",
  ...
  "flows.settings": "Impostazioni dei flussi",
  "flows.tabView": "Vista",
  "flows.unitAbout":
  ...
  "flows.windowFrom": "Dal",
  "flows.windowTo": "Al",
  "flows.windowSince": "Dal {date}",
  "flows.windowUntil": "Fino al {date}",
  "flows.windowDays": "{n} giorni",
  "flows.windowAbout":
    "Ogni grafico e ogni estratto della bacheca coprono questo periodo.",
  ...
  "flows.emptyPeople": "Nulla è passato tra persone in questo periodo.",
  "flows.given": "Ha dato",
  "flows.received": "Ha ricevuto",
  "flows.others": "Altri",
  "flows.trackLends": "Prestiti",
  "flows.unitLends": "prestiti",
  "flows.whoGaveTo": "Ha dato a",
  "flows.whoReceivedFrom": "Ha ricevuto da",
  ...
  "balances.planFewest": "Meno trasferimenti",
  "balances.planKnown": "Paga chi ti ha prestato",
  "balances.planKnownHint":
    "Ognuno segue un debito registrato, o una catena di debiti.",
  ...
  "alloc.bindTitle": "Pagato on-chain a",
  "alloc.bindAbout":
    "Il contratto invia ogni quota all'indirizzo legato a quel membro. Legata al suo Bundle, la quota viene divisa di nuovo lì — la cascata on-chain. Solo il wallet proprietario dell'holon, o quello già legato, può legare.",
  "alloc.bindReading": "Lettura del contratto…",
  "alloc.bindNobody": "Nessuno nella ripartizione, per ora.",
  "alloc.bindNotOnChain": "Non ancora nel contratto — prima aggiorna on-chain",
  "alloc.bindNone":
    "Non legata — resta nel contratto finché non viene riscossa",
  "alloc.bindWallet": "Wallet {address}",
  "alloc.bindBundle": "Il suo Bundle {address}",
  "alloc.bind": "Lega",
  "alloc.rebind": "Rilega",
  "alloc.bindTo": "Paga a",
  ...
  "alloc.bindWarnLoop":
    "Una parte torna indietro: {names}. Quella parte si ferma dove il ciclo si chiude.",
  "alloc.bindWarnLarge": "{n} holon in un solo invio — una transazione grande.",
  "alloc.bindWarnDeep": "{n} passaggi di profondità — una transazione grande.",
  "alloc.bindNotAllowed": "Questo wallet non può legare quella quota.",
  "alloc.bindOwnerIs": "Il wallet proprietario è {address}.",
  "alloc.bindSend": "Lega on-chain",
  "alloc.bindDone": "Legata on-chain — {hash}…",
  "alloc.bindFailed": "Impossibile legare: {reason}",
  ...
  "offers.scale.partners": "Federazione",
  "offers.cellReading": "leggo la cella…",
  "offers.here": "qui",
  "offers.onMap": "sulla mappa",
  "offers.auto": "auto",
  "offers.autoTitle": "Dallo scaffale",
  "offers.autoOn":
  ...
  "offers.emptySupplyLead":
    "Pubblica ciò che puoi dare, prestare o vendere — o allarga la scala.",
  "offers.emptyMatches": "Nessun incrocio a questa scala.",
  "offers.emptyMatchesNeeds":
    "Ci sono bisogni aperti ma nulla di offerto li raggiunge — allarga la scala o pubblica un'offerta.",
  ...
  "offers.uncovered": "{q} che nessuno può coprire",
  "offers.blocked": "{pct}% bloccato",
  "offers.covered": "coperto",
  "offers.role.provider": "Potresti servire",
  "offers.role.requester": "Potrebbero servirti",
  "offers.role.observer": "Intorno a te",
  "offers.state.proposed": "proposto",
  "offers.state.responded": "offerto",
  "offers.state.claimed": "accettato · consegna",
  "offers.state.settled": "consegnato",
  "offers.offerIt": "Offrilo",
  "offers.accept": "Accetta",
  "offers.handoff": "Consegna",
  "offers.view": "Vedi",
  "offers.mode.give": "Dare",
  "offers.mode.lend": "Prestare",
  "offers.mode.sell": "Vendere",
  "offers.status.open": "Aperta",
  "offers.status.reserved": "In parte promessa",
  "offers.status.fulfilled": "Consegnata",
  "offers.status.withdrawn": "Ritirata",
  "offers.status.expired": "Scaduta",
  "offers.need.requested": "Richiesto",
  "offers.need.offered": "Con risposte",
  "offers.need.claimed": "Accettato",
  "offers.need.fulfilled": "Soddisfatto",
  "offers.need.cancelled": "Annullato",
  "offers.need.request": "Richiesta",
  "offers.responses": "{n} risposte",
  "offers.listed": "{q} pubblicato",
  "offers.promised": "{q} promesso o consegnato",
  ...
  "offers.sharedPartners": "Condivisa con la federazione.",
  "offers.sharedMap": "Condivisa sulla mappa.",
  "offers.sharedBoth": "Condivisa con la federazione e sulla mappa.",
  "offers.sharedNone": "Non ancora condivisa.",
  "offers.until": "Fino al {date}",
  "offers.promisedTo": "Promessa a",
  "offers.resv.reserved": "riservato",
  "offers.resv.delivered": "consegnato",
  "offers.resv.released": "liberato",
  "offers.share": "Condividi vicino",
  "offers.shareLead": "Fin dove deve arrivare questa offerta?",
  "offers.sharePartners": "Partner della federazione",
  "offers.sharePartnersHint": "Visibile a {n} holon federati",
  "offers.sharePartnersNone": "Nessun partner federato ancora",
  "offers.shareMap": "Mappa pubblica (il tuo esagono)",
  "offers.shareMapHint": "Accende il livello Offerte nella tua cella e sopra",
  "offers.shareMapNone": "Imposta l'esagono nelle Impostazioni per attivarlo",
  "offers.shareBusy": "Pubblico…",
  "offers.shared": "Condivisa.",
  "offers.withdraw": "Ritira",
  "offers.withdrawConfirm": "Togliere “{name}” dal mercato?",
  "offers.withdrawn": "Offerta ritirata.",
  "offers.withdrawHeld":
  ...
  "offers.whatPlaceholder": "Farina, una scala, due ore di idraulica…",
  "offers.categoryPlaceholder": "cibo, attrezzi, competenze…",
  "offers.howMuch": "Quanto",
  "offers.unit": "Unità",
  "offers.how": "Come",
  "offers.price": "Prezzo per unità",
  "offers.currency": "Valuta",
  "offers.service": "Un servizio (tempo), non una cosa",
  "offers.notesPlaceholder": "Condizioni, ritiro, orari…",
  "offers.untilLabel": "Fino a (facoltativo)",
  "offers.save": "Salva",
  "offers.listIt": "Pubblica",
  "offers.saving": "Salvo…",
  "offers.howMany": "Quanti?",
  "offers.belowReserved": "Hai già promesso più di così.",
  "offers.closed": "Questa offerta è chiusa.",
  "offers.saved": "Offerta aggiornata.",
  "offers.created":
    "Offerta pubblicata qui. Condividila per raggiungere i partner e la mappa.",
  "offers.saveFailed": "Impossibile salvare l'offerta.",
  "offers.denied": "Non puoi cambiare questo.",
  "offers.signIn": "Accedi per partecipare al mercato.",
  "offers.offered": "Offerto {q} — chi l'ha chiesto ora può accettare.",
  "offers.ownNeed": "Quel bisogno è tuo.",
  "offers.insufficient": "Non ne resta abbastanza nell'offerta.",
  "offers.needClosed": "Quel bisogno è chiuso.",
  "offers.offerFailed": "Impossibile offrirlo.",
  "offers.accepted": "Accettato. Codice di consegna: {code}",
  "offers.nothingToAccept": "Niente da accettare ancora.",
  ...
  "offers.codeLead":
    "Lo schermo di chi lo chiede mostra un codice — scrivilo per confermare la consegna.",
  "offers.yourCode": "Il tuo codice di consegna: {code}",
  "offers.badCode":
    "Il codice non corrisponde — guarda lo schermo di chi lo chiede.",
  "offers.notReady": "La consegna non è ancora pronta.",
  "offers.confirmed": "Confermato da parte tua.",
  "offers.delivered": "Consegnato.",
  "offers.deliveredOffer": "Consegnato — offerta e scaffale aggiornati.",
  "offers.confirmFailed": "Impossibile confermare.",
  "offers.responsesTitle": "Risposte",
  "offers.acceptResponse": "Accetta",
  "offers.copyLink": "Copia il link a questa offerta",
  "offers.linkCopied": "Link copiato",
  "offers.waiting": "In attesa di chi lo chiede.",
  "offers.claimedBy": "Accettata — in attesa della consegna.",
  "stock.recordFailed": "Impossibile registrare.",
  "stock.minusOne": "Uno in meno di {name}",
