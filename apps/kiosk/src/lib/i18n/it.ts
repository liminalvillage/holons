...
export const it: Record<MessageKey, Msg> = {
  ...
  "alloc.settings": "Impostazioni di allocazione",
  "alloc.collective": "Collettivo OpenCollective",
  "alloc.collectiveHint": "Slug o URL del collettivo — vuoto per scollegare",
  "alloc.interior": "Interno / esterno",
  "alloc.allExterior": "Tutto esterno",
  "alloc.allInterior": "Tutto interno",
  "alloc.sharing": "Ripartizione esterna",
  "alloc.steep": "Ripida — l'anello interno prende tutto",
  "alloc.even": "Uniforme",
  "alloc.zones": "Zone",
  "alloc.fewer": "Una zona in meno",
  "alloc.more": "Una zona in più",
  "alloc.partners": "Partner per anello",
  "alloc.partnersAbout":
    "Tocca un anello per collocare un partner; chi non è collocato non riceve nulla.",
  "alloc.noPartners":
