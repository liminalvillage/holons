...
export const es: Record<MessageKey, Msg> = {
  ...
  "alloc.settings": "Ajustes de asignación",
  "alloc.collective": "Colectivo de OpenCollective",
  "alloc.collectiveHint": "Slug o URL del colectivo — vacío para desvincular",
  "alloc.interior": "Interior / exterior",
  "alloc.allExterior": "Todo exterior",
  "alloc.allInterior": "Todo interior",
  "alloc.sharing": "Reparto exterior",
  "alloc.steep": "Empinado — el anillo interior se lo lleva",
  "alloc.even": "Uniforme",
  "alloc.zones": "Zonas",
  "alloc.fewer": "Una zona menos",
  "alloc.more": "Una zona más",
  "alloc.partners": "Socios por anillo",
  "alloc.partnersAbout":
    "Toca un anillo para colocar un socio; los no colocados no reciben nada.",
