    ...
    for (const [schemaName, data] of Object.entries(testData)) {
        ...
        try {
            ...
            if (!schema) {
                ...
                results.push({ schema: schemaName, success: false, error: 'Schema not found' });
                continue;
            }
            ...
            results.push({ schema: schemaName, success: false, error: error.message });
        }
