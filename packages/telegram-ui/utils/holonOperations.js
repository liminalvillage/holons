 ...
 */
export async function createHolonBundle(holonsContract, creatorUserId, holonName, parameterValue) {
  try {
 ...
 */
export async function createBundleContracts(splitterContract, creatorUserId, holonName, parameterValue) {
  try {
