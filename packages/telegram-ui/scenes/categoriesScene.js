    ...
    Markup.inlineKeyboard([
      [
        Markup.button.callback(
          categoryTypes.roles[0].name,
          'category_' + categoryTypes.roles[0].name
        ),
        Markup.button.callback('ℹ️', 'explain_' + categoryTypes.roles[0].name),
      ],
      [
        Markup.button.callback(
          categoryTypes.roles[1].name,
          'category_' + categoryTypes.roles[1].name
        ),
        Markup.button.callback('ℹ️', 'explain_' + categoryTypes.roles[1].name),
      ],
      [
        Markup.button.callback(
          categoryTypes.roles[2].name,
          'category_' + categoryTypes.roles[2].name
        ),
        Markup.button.callback('ℹ️', 'explain_' + categoryTypes.roles[2].name),
      ],
      [
        Markup.button.callback(
          categoryTypes.roles[3].name,
          'category_' + categoryTypes.roles[3].name
        ),
        Markup.button.callback('ℹ️', 'explain_' + categoryTypes.roles[3].name),
      ],
      [
        Markup.button.callback(
          categoryTypes.roles[4].name,
          'category_' + categoryTypes.roles[4].name
        ),
        Markup.button.callback('ℹ️', 'explain_' + categoryTypes.roles[4].name),
      ],
      [
        Markup.button.callback(
          categoryTypes.roles[5].name,
          'category_' + categoryTypes.roles[5].name
        ),
        Markup.button.callback('ℹ️', 'explain_' + categoryTypes.roles[5].name),
      ],
      [
        Markup.button.callback(
          categoryTypes.roles[6].name,
          'category_' + categoryTypes.roles[6].name
        ),
        Markup.button.callback('ℹ️', 'explain_' + categoryTypes.roles[6].name),
      ],
    ])
  );
});
...
categoriesScene.action(/explain_(.+)/, ctx => {
  ...
  const category = categoryTypes.roles.filter(
