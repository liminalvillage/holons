...
export const NETWORK_CONFIG: Record<string, { chainId: number; name: string; rpcUrl?: string }> = {
  localhost: { chainId: 31337, name: 'Localhost', rpcUrl: 'http://127.0.0.1:8545' },
  hardhat: { chainId: 31337, name: 'Hardhat', rpcUrl: 'http://127.0.0.1:8545' },
  sepolia: { chainId: 11155111, name: 'Sepolia Testnet', rpcUrl: 'https://rpc.sepolia.org' },
  goerli: { chainId: 5, name: 'Goerli Testnet', rpcUrl: 'https://rpc.goerli.mudit.blog' },
  mainnet: { chainId: 1, name: 'Ethereum Mainnet' },
  homestead: { chainId: 1, name: 'Ethereum Mainnet' },  // alias
  gnosis: { chainId: 100, name: 'Gnosis Chain', rpcUrl: 'https://rpc.gnosischain.com' },
  polygon: { chainId: 137, name: 'Polygon Mainnet', rpcUrl: 'https://polygon-rpc.com' },
  arbitrum: { chainId: 42161, name: 'Arbitrum One', rpcUrl: 'https://arb1.arbitrum.io/rpc' },
  optimism: { chainId: 10, name: 'Optimism', rpcUrl: 'https://mainnet.optimism.io' },
  base: { chainId: 8453, name: 'Base', rpcUrl: 'https://mainnet.base.org' },
  virtualtestnet: { chainId: 1337, name: 'Virtual Testnet', rpcUrl: 'http://127.0.0.1:8545' },
};
...
export const DEPLOYMENTS: DeploymentsConfig = {
  localhost: {
    ...
    contracts: {
      ...
      SplitterFactory: { address: '0x414e49fE684f3561deF89740c642e6C6c380246E' },
      AppreciativeFactory: { address: '0x09254D834049de367305E429855b2CfD0E0A00ad' },
  ...
  homestead: {
    ...
    contracts: {
      SplitterFactory: { address: '0xB426156a15601C0103910E9c731Bb3615C2CFC92' },
      AppreciativeFactory: { address: '0x264c8344A60d0687c0312abF0187F582Ed225854' },
  ...
  virtualtestnet: {
    ...
    contracts: {
      SplitterFactory: { address: '0x20952eDCFD5700156d0A28DB7A6C0af8bA803ca2' },
      AppreciativeFactory: { address: '0x0f930ffff873765e08c44DBA77C901FC57c7e145' },
  ...
  gnosis: {
    ...
    contracts: {
      SplitterFactory: { address: '0x8F29D63161356cd3C4276ABADfe37329597a05F0' },
      AppreciativeFactory: { address: '0x7cca01Ad06b09a5c6455D530060b2BE26c147f5C' },
  ...
  sepolia: {
    ...
    contracts: {
      Splitter: {
        ...
        txHash: '0xadf03c09ce7cef43ea120ea362d892b4695cd5b09bc84ac0c9b45141b75d1bd6',
      ...
      ManagedFactory: {
        ...
        txHash: '0xc4cfa359eb3d80f6d24be4072fd761e280cd19e90dce18ef398eb7ea401e47e3',
        deployer: '0x22FCFCde1010aD545484E3D11B56E892Ba0F9A79'
      },
      ZonedFactory: {
        address: '0x0237ef39Ff014f00C088c225FEE8c19033043Bb3',
        deployedAt: 1765796460949,
        txHash: '0xdc98d028534a85e2f301a9ca8b27c69c2eec487299886c05fb32585b2314dfc1',
        deployer: '0x22FCFCde1010aD545484E3D11B56E892Ba0F9A79'
      },
      SplitterFactory: {
        address: '0x71b90590912D851e2c361dd0803Fd8148E293e45',
        deployedAt: 1765796474015,
        txHash: '0xef660814819e3c003f1e1be12d35ca9296ac99d237ba893f39505c8d19a84c73',
        deployer: '0x22FCFCde1010aD545484E3D11B56E892Ba0F9A79'
      },
      AppreciativeFactory: {
        address: '0x3Db4EDB81ce3fB5Ad2a781D02E7C5F65c2aAcecA',
        deployedAt: 1765796487153,
        txHash: '0x60ebd5f2b25c17dfc30fcb01f82d4fe1d6e094f66a3cc76395abcd846e80b659',
        deployer: '0x22FCFCde1010aD545484E3D11B56E892Ba0F9A79'
      },
      Holons: {
        address: '0xc67F3cd7065C8ea480da28E6026e7774D7C09dd5',
        deployedAt: 1765796500243,
        txHash: '0x943f6550f8bf749ad8728f3e55b0432007a9a5f19920f9aea90bd3f0d0297770',
        deployer: '0x22FCFCde1010aD545484E3D11B56E892Ba0F9A79'
      },
      TestToken: {
      ...
      Bundle: {
        ...
        txHash: '0x320ae406d26384992499e14140c0e8df35e23b3430ddb615e292d7b077c2a56a',
        deployer: '0x22FCFCde1010aD545484E3D11B56E892Ba0F9A79'
      },
    }
  }
...
export function getDeployment(networkKey: string): NetworkDeployments | undefined {
  return DEPLOYMENTS[networkKey];
}

// Helper to get contract address
export function getContractAddress(networkKey: string, contractName: string): string | undefined {
...
export function getContractAddresses(networkKey: string): Record<string, string> {
...
export function getChainId(networkKey: string): number | undefined {
  return NETWORK_CONFIG[networkKey]?.chainId || DEPLOYMENTS[networkKey]?.chainId;
}
